...
<!--
    ...
    https://nrs-projects.humboldt.edu/~ebp20/328hw/hw9/hw9-custom.php
-->

<head>
    <title> HW 9 - Problem 5 Custom </title>
    <meta charset="utf-8" />
    ...
    <script src="hw9-custom.js" type="text/javascript" async="async"> </script>
...
<body>
    ...
    <h1> BirdBook - Number of Sightings at Location - Custom javaScript </h1>
...
if(isset($_SESSION) && isset($_SESSION["username"]) && isset($_SESSION["password"]))
{
   ...
   else
   {
      ...
      {
         // Display results
         require_once('hw8-prob3-result.php');
      }
      else 
      {
         // Display options
         require_once('hw8-prob3-select.php');
      }
   }
}
...
?>
    ...
    <input id="bestLocButton" type="button" value="Show Best Location" />
