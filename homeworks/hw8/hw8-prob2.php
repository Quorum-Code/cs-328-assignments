...
<!--
    ...
    https://nrs-projects.humboldt.edu/~ebp20/328hw/hw8/hw8-prob2.php
-->

<head>
    <title> HW 8 - Problem 2 </title>
    <meta charset="utf-8" />
...
<body>
    ...
    <h1> Howard's Horrors - Title Total Cost </h1>
...
if(isset($_SESSION) && isset($_SESSION["username"]) && isset($_SESSION["password"]))
{
   ...
   else
   {
      ...
      {
         // Display results
         require_once('hw8-prob2-result.php');
      }
      else 
      {
         // Display options
         require_once('hw8-prob2-select.php');
      }
   }
}
